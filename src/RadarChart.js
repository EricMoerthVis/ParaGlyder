...
function RadarChart(id, data, legendText, options) {
    var cfg = {
        ...
        if (cfg.showDots) {
            ...
            blobWrapper.selectAll(".radarCircle")
                ...
                .attr("cx", function (d, i) {
                    return rScale(d.mean) * Math.cos(angleSlice * i - Math.PI / 2);
                })
                .attr("cy", function (d, i) {
                    return rScale(d.mean) * Math.sin(angleSlice * i - Math.PI / 2);
                })
